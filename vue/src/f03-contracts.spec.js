...
describe('F03 CSS and motion contracts', () => {
  it('keeps the warm Notion-neutral substrate and classification colors token-driven', () => {
    const tokenCss = readFileSync(resolve(process.cwd(), 'src/assets/tailwind.css'), 'utf8')

    expect(tokenCss).toContain('--neutral-25: #fbfbfa;')
    expect(tokenCss).toContain('--neutral-50: #f7f7f5;')
    expect(tokenCss).toContain('--neutral-100: #f1f1ef;')
    expect(tokenCss).toContain('--neutral-200: #e7e7e4;')
    expect(tokenCss).toContain('--neutral-300: #d3d3cf;')
    expect(tokenCss).toContain('--neutral-600: #5f5e5a;')
    expect(tokenCss).toContain('--neutral-900: #2f2e2a;')
    expect(tokenCss).toContain('--selection-50: #fff0e6;')
    expect(tokenCss).toContain('--selection-700: #9a4d00;')
    expect(tokenCss).toContain('--selection-bg: #45250f;')
    expect(tokenCss).toContain('--selection-fg: #ffc078;')
    expect(tokenCss).toContain('--brand-600: #a84b00;')
    expect(tokenCss).toContain('--primary: var(--brand-600);')
