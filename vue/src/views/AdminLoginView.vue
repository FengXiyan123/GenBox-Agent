<template>
  <div class="relative grid min-h-dvh place-items-center bg-admin-bg px-4 py-16 sm:px-6">
    <ThemeToggle class="absolute right-4 top-4 sm:right-6 sm:top-6" />
    <main class="w-full max-w-[440px]">
      <div class="mb-5 flex items-center gap-3 px-1">
        <div class="grid size-9 place-items-center rounded-md bg-primary text-caption font-bold text-primary-foreground">GA</div>
        <div>
          <p class="m-0 text-caption text-muted-foreground">GenBox-Agent</p>
