package com.genbox.ai.auth.support;
...
public class AdminJwtTokenService {
    ...
    public Claims parseToken(String token) {
        try {
            ...
            throw new GenBoxAgentFrameException(401, "后台登录已过期，请重新登录", exception);
        } catch (JwtException | IllegalArgumentException exception) {
            throw new GenBoxAgentFrameException(401, "后台登录无效，请重新登录", exception);
        }
    }
}
