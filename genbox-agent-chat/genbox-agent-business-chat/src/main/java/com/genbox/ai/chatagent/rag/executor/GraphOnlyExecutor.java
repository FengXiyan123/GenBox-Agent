...
import com.genbox.ai.chatagent.rag.service.GraphAnswerRenderer;
import com.genbox.ai.chatagent.rag.service.StructureGraphQueryEngine;
import com.genbox.ai.chatagent.rag.support.ExecutorEventSupport;
...
import com.genbox.ai.manage.model.graph.GraphQueryResult;
import com.genbox.ai.manage.model.graph.GraphSectionWithChildren;
import com.genbox.ai.manage.model.graph.GraphSectionWithSiblings;
...
public class GraphOnlyExecutor implements ConversationExecutor {
    ...
    public Flux<String> execute(TaskInfo taskInfo) {
        ...
        if (decision.getNavigationAction() == com.genbox.ai.chatagent.rag.model.DocumentNavigationAction.SECTION_ADJACENCY_LOOKUP) {
