...
import com.genbox.ai.manage.model.es.DocumentNavigationIndexRecord;
...
public class ElasticsearchDocumentNavigationIndexService implements DocumentNavigationIndexService {
    ...
    @Override
    public void reindexDocumentNodes(Long documentId, Long parseTaskId, List<GenBoxAgentDocumentStructureNode> nodes) {
        if (documentId == null) {
            return;
        }
    ...
    private DocumentNavigationIndexRecord toIndexRecord(GenBoxAgentDocumentStructureNode node, Long parseTaskId) {
